    ...
    await sheets.spreadsheets.values.append({
      ...
      requestBody: {
        values: [[
          ...
          firstName?.trim() || '',             // B: First Name (optional)
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: -apple-system, system-ui, sans-serif; max-width: 520px; margin: 0 auto; padding: 40px 24px; color: #101418;">
            ...
            <h1 style="font-size: 28px; font-weight: 700; letter-spacing: -.03em; margin: 0 0 16px;">Hey ${firstName?.trim() || 'there'}, you're on the list.</h1>
